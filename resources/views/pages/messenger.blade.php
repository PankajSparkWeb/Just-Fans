        ...
        <div class="min-vh-100 col-12">
            <div class="container messenger min-vh-100 message-layout-inner">
                <div class="row min-vh-100 message-layout-flex">
                    <div class="col-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-2 border border-right-0 border-left-0 rounded-left conversations-wrapper min-vh-100 overflow-hidden border-top message-section-right">
                    ...
                    <div class="col-9 col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-10 border conversation-wrapper rounded-right p-0 d-flex flex-column min-vh-100 messanger-left-section">
