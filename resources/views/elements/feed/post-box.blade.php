    ...
    <div class="post-content mt-3  pl-3 pr-3 upvote_downvote_section">
		   ...
		   @if (
				...
				<div class="upvote-downvote">
					<div title="{{ __('Upvote') }}" class="upvote-icon react-button {{ $is_react_type == 'like' ? 'active' : '' }}"  onclick="Post.reactToPost(this, 'post',{{ $post->id }}, 'like')">
						<div class="upvoteLink" >
					  <span class="material-symbols-outlined">shift</span></div>
					</div>        
					...
					<div title="{{ __('Downvote') }}" class="down-vote-icon react-button {{ $is_react_type == 'dislike' ? 'active' : '' }}"  onclick="Post.reactToPost(this, 'post',{{ $post->id }}, 'dislike')">
			...
			{{-- Not login redirect to login page --}}	
				<div class="upvote-downvote disabled_section">
					<div class="upvote-icon">
						<a href="" class="upvoteLink_disabled">
