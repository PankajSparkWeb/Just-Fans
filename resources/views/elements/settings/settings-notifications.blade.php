<form>
    ...
    @if(getSetting('profiles.enable_new_post_notification_setting'))
        <div class="form-group">
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label setting-toggle-icon" for="notification_email_new_post_created">{{__('New content has been posted')}}</label>
            </div>
        </div>
    @endif
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_new_sub">{{__('New subscription registered')}}</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_new_tip">{{__('Received a tip')}}</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_new_ppv_unlock">{{__('Your PPV content has been unlocked')}}</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_new_message">{{__('New message received')}}</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_new_comment">{{__('New comment received')}}</label>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_expiring_subs">{{__('Expiring subscriptions')}}</label>
        </div>
    </div>
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label setting-toggle-icon" for="notification_email_renewals">{{__('Upcoming renewals')}}</label>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label setting-toggle-icon" for="notification_email_creator_went_live">{{__('A user I am following went live')}}</label>
            </div>
        </div>
