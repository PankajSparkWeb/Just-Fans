            ...
            @if (Auth::check())
                <div class="dropdown-menu-header" aria-labelledby="dropdownMenuButton">
                    ...
                    <div class="dropdown-menu " id="myDropdown">
                        ...
                        <li><a class="dropdown-items menu-option" href="{{ route('my.messenger.get') }}">Messages</a>
                        </li>
                        <li><a class="dropdown-items menu-option" href="{{ route('posts.create') }}">Create Post</a>
                        </li>
                        <li><a class="dropdown-items menu-option"
                                href="{{ route('my.notifications') }}">Notification</a></li>
